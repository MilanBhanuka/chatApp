...
const ProfileUpdate = () => {
  ...
  return (
    <div className='min-h-screen bg-gradient-to-r from-blue-400 to-blue-500 items-center justify-center flex '>
      <div className='grid grid-cols-3 bg-white justify-center items-center w-5/6  lg:w-1/2 rounded-lg py-3'>
        <div className='col-span-2 flex w-full px-3.5'>
          <form className='flex flex-col gap-5 p-1 w-full items-center  '>
            ...
            <input type='text' placeholder='Name' required className='w-3/4 bg-blue-100 p-1 rounded-lg' />
            <textarea placeholder='Bio' required className='w-3/4 bg-blue-100 p-1 rounded-lg' />
